...
!macro StartVergeService
  ...
  SimpleSC::ExistsService "clash-verge-service"
  Pop $0  ; 0：service exists；other: service not exists
  ; Service exists
  ${If} $0 == 0
    Push $0
    ; Check if the service is running
    SimpleSC::ServiceIsRunning "clash-verge-service"
    ...
    ${If} $0 == 0
      ...
      ${If} $1 == 0
            ...
            SimpleSC::StartService "clash-verge-service" "" 30
      ${EndIf}
    ${ElseIf} $0 != 0
          Push $0
  ...
  ${If} $0 == 0
    ...
    ${If} $0 == 0
      ...
      ${If} $1 == 1
        ...
        SimpleSC::StopService "clash-verge-service" 1 30
        Pop $0 ; returns an errorcode (<>0) otherwise success (0)
        ${If} $0 == 0
              DetailPrint "Removing clash-verge-service..."
              SimpleSC::RemoveService "clash-verge-service"
        ${ElseIf} $0 != 0
                  Push $0
                  SimpleSC::GetErrorMessage
                  Pop $0
